<?php
	...
	function agregar_banner($titulo,$imagen_banner,$estado)
	{
		$sql_agregar = "INSERT INTO banner(titulo,imagen_banner,estado)VALUES('$titulo','$imagen_banner','$estado')";
		
		query($sql_agregar,$cn) or die(mysql_error());
	
	}
	
	function editar_banner($codigo,$titulo,$imagen_banner,$estado)
	{
		$sql_editar  = "UPDATE banner SET titulo = '$titulo', imagen_banner = '$imagen_banner', estado = '$estado' WHERE idbanner = '$codigo'";
	...
	function eliminar_banner($cod)
	{
		...
		if($fotoprincipal!="")
		{
			@unlink("../../images/slider/$fotoprincipal");
		}		
