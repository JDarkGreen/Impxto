<?php
	...
	if(!isset($_POST['editar']))
	{
		...
		if ($imagen_banner->uploaded)
		{
			...
			$imagen_banner->process('../../images/slider-2/');			
			$foto_imagen_banner = $imagen_banner->file_dst_name;
		}		
					
		agregar_banner_small($titulo_banner,$foto_imagen_banner,1);
	...
	if(isset($_POST['editar']))
	{
		if($_POST['editar']=='1')
		{
			...
			{				
					...
					$handle->process("../../images/slider-2/");
			...
			editar_banner_small($_POST['codigo'],$titulo_banner,$imagen_banner,1);
